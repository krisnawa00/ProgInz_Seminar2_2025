			...
			IProfessorRepo profRepo, IGradeRepo grRepo, ICourseRepo courseRepo)
	{
		return new CommandLineRunner() {
			...
			public void run(String... args) throws Exception {
				...
				Grade g2 = new Grade(9, s1, c2);
				Grade g3 = new Grade(3, s2, c1);
				Grade g4 = new Grade(8, s2, c2);
				Grade g5 = new Grade(10, s2, c3);
				Grade g6 = new Grade(7, s3, c2);
				Grade g7 = new Grade(5, s3, c3);
